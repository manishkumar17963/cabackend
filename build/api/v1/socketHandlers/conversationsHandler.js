                                ...
                                receiverId: {
                                    $cond: {
                                        if: {
                                            $or: [
                                                {
                                                    $eq: [conversationType_1.default.Direct, "$conversationType"],
                                                },
                                                {
                                                    $eq: [conversationType_1.default.Primary, "$conversationType"],
                                                },
                                            ],
                                        },
                                        then: {
                                            $cond: {
                                                if: {
                                                    $eq: [
                                                        (_a = userDetails._id) === null || _a === void 0 ? void 0 : _a.toString(),
