...
CustomerRouter.post("/add/kyc", auth_1.default(customer_2.default), customer_1.addKycHandler);
...
CustomerRouter.post("/add/other/meeting", [auth_1.default(customer_2.default)], customer_1.addMeetingHandler);
