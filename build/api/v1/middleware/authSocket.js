...
var verifyTokenSocket = function (socket, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, Collection, user, err_1, socketError;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                Collection = void 0;
                if (decoded.type == sendBy_1.default.Admin) {
                    Collection = admin_1.default;
                }
                else if (decoded.type == sendBy_1.default.Employee) {
                    Collection = employee_1.default;
                }
                else {
                    Collection = customer_1.default;
                }
            ...
            case 3:
                err_1 = _b.sent();
                socketError = new Error("NOT_AUTHORIZED");
                return [2 /*return*/, next(socketError)];
            case 4:
                next();
                return [2 /*return*/];
        }
